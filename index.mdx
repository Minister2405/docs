---
title: "Introduction"
description: "Welcome to the new home for your documentation. Here us where all your questions are answered"
---

## Setting up

<kbd>This is a description</kbd>

<Card icon="sparkles" title="Test">
  Test
</Card>

<Columns cols={2}>
  <Card icon="sparkles" title="Test1">
    <Card icon="sparkles" title="Test1">
...
Design a docs site that looks great and empowers your users and your business.

<Columns cols={2}>
  <Card icon="pen-to-square" href="/development" title="Edit locally">
    Edit your docs locally and preview them in real time without moving away from your seat.
  </Card>
